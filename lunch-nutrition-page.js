document.addEventListener('DOMContentLoaded', () => {
    ...
    const input = document.getElementById('lunch');
    const gramInput = document.getElementById('lunchGram');
    const addBtn = document.querySelector('.add-btn[data-meal="Lunch"]');
    ...
    let addedFoods = JSON.parse(localStorage.getItem(`lunch-${currentDate}`)) || [];
    ...
    function updateChart() {
        ...
        localStorage.setItem(`lunch-${currentDate}`, JSON.stringify(addedFoods));
        localStorage.setItem(`lunch-totals-${currentDate}`, JSON.stringify({
