document.addEventListener('DOMContentLoaded', () => {
    ...
    const input = document.getElementById('snacks');
    const gramInput = document.getElementById('snacksGram');
    const addBtn = document.querySelector('.add-btn[data-meal="Snacks"]');
    ...
    let addedFoods = JSON.parse(localStorage.getItem(`snacks-${currentDate}`)) || [];
    ...
    function updateChart() {
        ...
        localStorage.setItem(`snacks-${currentDate}`, JSON.stringify(addedFoods));
        localStorage.setItem(`snacks-totals-${currentDate}`, JSON.stringify({
