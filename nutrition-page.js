document.addEventListener('DOMContentLoaded', () => {
    ...
    const input = document.getElementById('frukost');
    const gramInput = document.getElementById('frukostGram');
    const addBtn = document.querySelector('.add-btn[data-meal="Frukost"]');
    ...
    let addedFoods = JSON.parse(localStorage.getItem(`frukost-${currentDate}`)) || [];
    ...
    function updateChart() {
        ...
        localStorage.setItem(`frukost-${currentDate}`, JSON.stringify(addedFoods));
        localStorage.setItem(`frukost-totals-${currentDate}`, JSON.stringify({
